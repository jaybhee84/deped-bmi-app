  ...
  async function handleSave() {
    ...
    if (ok) {
      ...
      function renderCriterionOption(c) {
        ...
        const isRestricted =
          config.criterionGradeRestrictions?.[c] !== undefined;
            ...
            <div className="card">
              <div className="sdo-settings-header">
                <h3 className="card-title">
                  Official SBFP Beneficiary Criteria
                </h3>
                {config.setBy && (
              ...
              <div className="sdo-notice">
                ...
                <span>
                  Once saved, <strong>all schools</strong> will automatically
                  see the official SBFP beneficiaries in their Students and
                  Reports pages — from Baseline through Endline.
                </span>
              </div>
                ...
                <div className="sdo-summary">
                  {totalSelected === 0 ? (
                    ...
                    <span className="sdo-summary-text">
                      ...
                      <strong>{config.criteria.length}</strong> nutritional
                      status
            ...
            <div className="card">
              ...
              {totalSelected === 0 ? (
                <div className="sdo-preview-empty">
                  ...
                  <p style={{ fontSize: 12 }}>
                    Select grades and/or nutritional status criteria on the left
                    and click Save.
                  </p>
                </div>
              ) : (
